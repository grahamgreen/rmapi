...
This tuorial wil show you how to leverage [rmapi](https://github.com/grahamgreen/rmapi) and `Automator` to print
...
```bash
curl -L  https://github.com/grahamgreen/rmapi/releases/download/v0.0.25/rmapi-macosx.zip -o rmapi.zip
```
